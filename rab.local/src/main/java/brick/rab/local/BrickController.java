...
public class BrickController {
	private  BrickConnect brickLeft;
	private  BrickConnect brickRight;
	...
	private void initialize() {
		try {
			...
			brickLeft 			= new BrickConnect(RabStatics.getiPBrickLeft());		
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		try {
			...
			brickRight 			= new BrickConnect(RabStatics.getiPBrickRight());
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	private void setupHings(){
		try {
			...
			hingTheta20.setAcceleration(RabStatics.getMaxAcceleration());
			hingTheta21.setAcceleration(RabStatics.getMaxAcceleration());
			hingTheta3.setAcceleration(RabStatics.getMaxAcceleration());
			hingTheta4.setAcceleration(RabStatics.getMaxAcceleration());
			hingTheta1.setAcceleration(RabStatics.getMaxAcceleration());
			effector.setAcceleration(RabStatics.getMaxAcceleration());
		} catch(Exception e) {
			e.printStackTrace();
		}
	}
	...
	public  BrickConnect getBrickLeft() {
		return brickLeft;
	}

	public  BrickConnect getBrickRight() {
		return brickRight;
	}
}
