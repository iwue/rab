...
public class front extends JFrame {
	...
	public front() {
		...
		Y = new JTextField();
		Y.setBounds(56, 80, 106, 20);
		contentPane.add(Y);
		Y.setColumns(10);
		
		Z = new JTextField();
		Z.setBounds(56, 163, 106, 20);
		contentPane.add(Z);
		Z.setColumns(10);
		
		X = new JTextField();
		X.setBounds(251, 163, 106, 20);
		contentPane.add(X);
		X.setColumns(10);
		...
		Ycoordinate.setBounds(56, 53, 87, 16);
		...
		Zcoordinates.setBounds(56, 138, 106, 14);
		...
		Xcoordinates.setBounds(251, 138, 106, 14);
		contentPane.add(Xcoordinates);
		
		JButton btnNewButton = new JButton("Run");
		btnNewButton.setBounds(300, 215, 91, 23);
		...
		choose.setBounds(230, 53, 161, 23);
